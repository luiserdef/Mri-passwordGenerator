...
function generatePassword (filterStatus, passwordLength) {
  ...
  if (filterStatus.upperCase) { passCharacters += upperCase }
  if (filterStatus.numbers) { passCharacters += numbers }
  if (filterStatus.symbols) { passCharacters += specialCharacters }
