...
function App () {
  ...
  return (
    <div className='bg-[#011d2e] w-full h-screen text-white flex flex-col justify-center items-center'>
      <h1 className='luiserdef-title text-4xl pb-4 text-center font-bold'>Mr. Incredible Password Generator</h1>
      <div className='luiserdef-gp-container relative w-[80%] h-auto max-w-lg bg-[#01364d] rounded-xl px-10 flex flex-col items-center'>
        ...
        />
        <button
          className={`${isSliderActive ? 'bg-[#339ab14f]' : 'bg-[#07d3a781]'} luiserdef-bt-generate-pass select-none lg:hover:bg-[#43d7f1] rounded-md py-2 px-2 mt-10 mb-4`}
